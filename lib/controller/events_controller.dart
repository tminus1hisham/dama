  ...
  Future<void> fetchEvents() async {
    ...
    try {
      ...
      if (fetchedEvents.isNotEmpty) {
        ...
        debugPrint(
          '   First event date: ${firstEvent.eventDate} (${firstEvent.eventDate.year}-${firstEvent.eventDate.month}-${firstEvent.eventDate.day})',
        );
      }
      ...
      if (eventsList.isNotEmpty) {
        ...
        debugPrint(
          '   First in list date: ${firstInList.eventDate} (${firstInList.eventDate.year}-${firstInList.eventDate.month}-${firstInList.eventDate.day})',
        );
      }
      ...
      case 'upcoming':
        final upcoming =
            events.where((e) {
              ...
              final eventLocal =
                  e.eventDate.isUtc ? e.eventDate.toLocal() : e.eventDate;
