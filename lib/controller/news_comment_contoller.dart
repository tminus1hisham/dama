...
class NewsCommentController extends GetxController {
  ...
  Future<void> addComment(String newsId, String commentText) async {
    ...
    try {
      ...
      await _commentService.addNewsComment(commentModel, newsId);
    } catch (e) {
      comments.update(newsId, (existing) => existing..removeLast());
      Get.snackbar(
