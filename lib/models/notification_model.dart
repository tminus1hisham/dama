...
class NotificationModel {
  ...
  factory NotificationModel.fromJson(Map<String, dynamic> json) {
    debugPrint(
      '[NotificationModel.fromJson] Raw JSON keys: ${json.keys.toList()}',
    );
    ...
    if (json['data'] != null) {
      if (json['data'] is Map) {
        ...
        if (extractedType == null || extractedType.isEmpty) {
          extractedType =
              dataMap['type']?.toString() ?? dataMap['data']?.toString();
        }
    ...
    debugPrint(
      '  [Getters] notificationType: ${notification.notificationType}',
    );
  ...
  String? get notificationType {
    ...
    if (data != null) {
      ...
      if (data!.containsKey('blogPost') ||
          data!.containsKey('blog') ||
          data!.containsKey('blogId')) {
        return 'blog';
      }
      if (data!.containsKey('newsPost') ||
          data!.containsKey('news') ||
  ...
  String? get refId {
    ...
    if (data != null) {
      ...
      final trainingId =
          data!['training'] ?? data!['trainingId'] ?? data!['training_id'];
      if (trainingId != null) return trainingId.toString();

      // Check for session ID
      final sessionId =
          data!['session'] ?? data!['sessionId'] ?? data!['session_id'];
