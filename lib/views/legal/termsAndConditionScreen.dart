...
//           buildSectionTitle('AGREEMENT TO OUR LEGAL TERMS', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('1. OUR SERVICES', isDarkMode),
//           buildParagraph(
//             "The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.",
//             isDarkMode,
//           ),

//           buildSectionTitle('2. INTELLECTUAL PROPERTY RIGHTS', isDarkMode),
//           buildSubsectionTitle('Our intellectual property', isDarkMode),
//           buildParagraph(
...
//             isDarkMode,
//           ),
//           buildSubsectionTitle('Your use of our Services', isDarkMode),
//           buildParagraph(
//             "Subject to your compliance with these Legal Terms, including the 'PROHIBITED ACTIVITIES' section below, we grant you a non-exclusive, non-transferable, revocable licence to:",
//             isDarkMode,
//           ),
//           buildBulletPoint("access the Services; and", isDarkMode),
//           buildBulletPoint("download or print a copy of any portion of the Content to which you have properly gained access,", isDarkMode),
//           buildParagraph(
//             "solely for your personal, non-commercial use or internal business purpose.",
//             isDarkMode,
//           ),

//           buildSectionTitle('3. USER REPRESENTATIONS', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('4. USER REGISTRATION', isDarkMode),
//           buildParagraph(
//             "You may be required to register to use the Services. You agree to keep your password confidential and will be responsible for all use of your account and password. We reserve the right to remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is inappropriate, obscene, or otherwise objectionable.",
//             isDarkMode,
//           ),

//           buildSectionTitle('5. PURCHASES AND PAYMENT', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('6. SUBSCRIPTIONS', isDarkMode),
//           buildSubsectionTitle('Billing and Renewal', isDarkMode),
//           buildParagraph(
...
//             isDarkMode,
//           ),
//           buildSubsectionTitle('Free Trial', isDarkMode),
//           buildParagraph(
...
//             isDarkMode,
//           ),
//           buildSubsectionTitle('Cancellation', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('7. SOFTWARE', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('8. PROHIBITED ACTIVITIES', isDarkMode),
//           buildParagraph(
//             "You may not access or use the Services for any purpose other than that for which we make the Services available. The Services may not be used in connection with any commercial endeavours except those that are specifically endorsed or approved by us.",
//             isDarkMode,
//           ),
//           buildParagraph("As a user of the Services, you agree not to:", isDarkMode),
//           buildBulletPoint("Systematically retrieve data or other content from the Services to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us.", isDarkMode),
//           buildBulletPoint("Trick, defraud, or mislead us and other users, especially in any attempt to learn sensitive account information such as user passwords.", isDarkMode),
//           buildBulletPoint("Circumvent, disable, or otherwise interfere with security-related features of the Services.", isDarkMode),
//           buildBulletPoint("Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Services.", isDarkMode),
//           buildBulletPoint("Use any information obtained from the Services in order to harass, abuse, or harm another person.", isDarkMode),
//           buildBulletPoint("Make improper use of our support services or submit false reports of abuse or misconduct.", isDarkMode),
//           buildBulletPoint("Use the Services in a manner inconsistent with any applicable laws or regulations.", isDarkMode),
//           buildBulletPoint("Upload or transmit viruses, Trojan horses, or other material that interferes with any party's uninterrupted use and enjoyment of the Services.", isDarkMode),

//           buildSectionTitle('9. USER GENERATED CONTRIBUTIONS', isDarkMode),
//           buildParagraph(
...
//             isDarkMode,
//           ),
//           buildBulletPoint("Your Contributions are not false, inaccurate, or misleading.", isDarkMode),
//           buildBulletPoint("Your Contributions are not obscene, lewd, lascivious, filthy, violent, harassing, libellous, slanderous, or otherwise objectionable.", isDarkMode),
//           buildBulletPoint("Your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.", isDarkMode),
//           buildBulletPoint("Your Contributions do not violate any applicable law, regulation, or rule.", isDarkMode),

//           buildSectionTitle('10. CONTRIBUTION LICENCE', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('11. GUIDELINES FOR REVIEWS', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('12. SOCIAL MEDIA', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('13. SERVICES MANAGEMENT', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('14. PRIVACY POLICY', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('15. COPYRIGHT INFRINGEMENTS', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('16. TERM AND TERMINATION', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('17. MODIFICATIONS AND INTERRUPTIONS', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('18. GOVERNING LAW', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('19. DISPUTE RESOLUTION', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('20. CORRECTIONS', isDarkMode),
//           buildParagraph(
//             "There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.",
//             isDarkMode,
//           ),

//           buildSectionTitle('21. DISCLAIMER', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('22. LIMITATIONS OF LIABILITY', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('23. INDEMNIFICATION', isDarkMode),
//           buildParagraph(
...
//           buildSectionTitle('28. CONTACT US', isDarkMode),
//           buildParagraph(
...
import 'package:dama/utils/constants.dart';
import 'package:dama/utils/theme_provider.dart';
import 'package:dama/widgets/legal_widgets.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          buildHeader('Terms of Use', isDarkMode),
