...
//   const SelectedBlog({required this.blogId});
//
//   final String blogId;
//
//   @override
//   State<SelectedBlog> createState() => _SelectedBlogState();
// }
//
...
//   );
//   final FetchBlogByIdController _newsController = Get.put(
...
//   void initState() {
//     super.initState();
//     _newsController.fetchBlog(widget.blogId).then((_) {
//       final newsItem = _newsController.blog.value;
...
//         }
//
//         final news = _newsController.blog.value;
//         if (news == null) {
